...
# == Functions
#   Build:
#     python motif-x.py --if filename 
#
#   This command generate peptide motifs with 9-mers and uses parameters specified in the config.txt file:
#     python motif_finder.py 9 data.dat config.txt
#
#   Like the first example, but with verbose output:
#     python motif_finder.py -v 9 data.dat
#
...
#            return self.motifSet, self.motifSetRef
        ...
        # format for final regular expression
        ...
        self.motifSetRef[rexp_motif_str] = [fg_vs_branch, bg_vs_branch, binomial_p, l_enrichment, score, 
                                        fold_enrichment, num_in_fg, num_in_bg]
        self.motifDict[rexp_motif_str] = motif_identified
